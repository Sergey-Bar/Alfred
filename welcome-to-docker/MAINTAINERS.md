...
To add users to the image, you can use the following command:

```bash
curl -X POST http://127.0.0.1:8000/v1/admin/users \
  -H "Content-Type: application/json" \
  -d '{"email": "your@email.com", "name": "Your Name", "personal_quota": 100000}'
```
