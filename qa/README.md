...
- **HTML Report**: `qa/results/html/index.html`
- **JSON Results**: `qa/results/results.json`
- **Screenshots**: `qa/results/test-results/<test-name>/`
- **Videos**: `qa/results/test-results/<test-name>/video.webm`
- **Traces**: `qa/results/test-results/<test-name>/trace.zip`

## Configuration

Playwright configuration is in `src/frontend/playwright.config.js`:
...
1. Create a new spec file in `qa/Tests/`
