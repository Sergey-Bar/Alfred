...
# Run with coverage (output: qa/results/coverage)
...
- HTML reports: `qa/results/html/`
- Screenshots, videos, traces: `qa/results/test-results/`
- Code coverage: `qa/results/coverage/`
- JSON results: `qa/results/results.json`

### Unit Test Coverage
```bash
# Coverage report location
qa/results/coverage/index.html
````
...
| Screenshots  | `qa/results/test-results/` |
...
**Need Help?** Check [qa/README.md](./README.md) for detailed documentation.
