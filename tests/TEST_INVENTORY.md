...
All tests are now organized under `qa/` (except frontend unit tests which remain co-located with source code).
...
- **Results**: `qa/results/test-results/`
- **Reports**: `qa/results/html/`
...
### February 12, 2026
- ✅ Reorganized all tests under `qa/`
...
- **Backend Tests**: Moved from `backend/tests/` to `qa/Backend/`
- **E2E**: Reorganized from `qa/Tests/` to `qa/E2E/`
- **Frontend**: Remain in `src/frontend/src/__tests__/` (best practice)
...
- **Vitest Config**: `src/frontend/vitest.config.js`
- **Playwright Config**: `src/frontend/playwright.config.js`
