...
**File**: `src/frontend/vitest.config.js`
...
### Unit Test Coverage
```bash
open qa/results/coverage/index.html
```
...
- **QA README**: [qa/README.md](qa/README.md)
- **Playwright Config**: [src/frontend/playwright.config.js](src/frontend/playwright.config.js)
- **Vitest Config**: [src/frontend/vitest.config.js](src/frontend/vitest.config.js)
- **CI Workflow**: [.github/workflows/ci.yml](.github/workflows/ci.yml)

## Support

For questions or issues with tests:
1. Check the [QA README](qa/README.md)
