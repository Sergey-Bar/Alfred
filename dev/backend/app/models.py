...
[KEY ENTITIES]
- User: Identity and personal quota holder.
- Team: Grouping entity for shared liquidity pools.
- RequestLog: High-frequency transaction record for every AI interaction.
- ApprovalRequest: Workflow entity for manual quota replenishment.
"""
