...
[PIPELINE ORDER]
1. SecurityHeadersMiddleware: Enforces browser-level protection (Outermost).
2. RequestContextMiddleware: Establishes tracing and correlation IDs.
3. RateLimitMiddleware: Protects upstream providers from abusive traffic patterns.
"""
...
def setup_middleware(app: FastAPI) -> None:
    """
    Middleware Orchestration Entrypoint.
    
    Initializes and mounts middleware in the specific order required for 
