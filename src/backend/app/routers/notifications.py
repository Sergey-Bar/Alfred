...
from ..dependencies import get_session, get_current_user, require_admin
...
async def get_user_notifications(user: User = Depends(get_current_user), session: Session = Depends(get_session)):
    nm = get_notification_manager()
