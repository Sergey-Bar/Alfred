...
// Logic: Skeleton, SkeletonCard, and SkeletonTable provide animated loading placeholders for UI elements, improving perceived performance and UX during data fetches.
// Why: Prevents layout shift and gives users visual feedback while loading.
// Root Cause: Sudden content pop-in and layout shift degrade UX.
// Context: Used throughout dashboard for cards, tables, and lists. Future: consider extracting to shared UI library.
// Model Suitability: Skeleton loader logic is standard; GPT-4.1 is sufficient.
