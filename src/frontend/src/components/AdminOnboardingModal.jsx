...
// Logic: Provides an interactive onboarding modal for new admin users, with step-by-step walkthrough and contextual help links.
// Why: The current UserGuide is static; admins need a guided, actionable onboarding experience to reduce time-to-value and support burden.
// Root Cause: No interactive onboarding or contextual help for admins; only static documentation.
// Context: This modal is triggered on first login for admins, can be re-launched from the User Guide or profile menu. Future: Consider product tours or contextual tooltips for deeper onboarding.
