...
// Logic: DateRangePicker provides a dropdown for selecting common date ranges or a custom year, with outside click handling and formatted display.
// Why: Enables users to filter analytics and reports by relevant time periods.
// Root Cause: Hardcoded or inflexible date filters limit reporting and analytics usability.
// Context: Used in dashboard analytics and reporting. Future: add calendar picker and i18n support.
// Model Suitability: Date range picker logic is standard; GPT-4.1 is sufficient.
