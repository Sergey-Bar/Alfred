...
// Logic: ConfirmDialog is a modal for confirming user actions, supporting danger, warning, info, and confirm types. Handles focus, escape key, and loading state.
// Why: Prevents accidental or unintended actions by requiring explicit user confirmation.
// Root Cause: Unconfirmed actions can lead to data loss or errors.
// Context: Used for confirming destructive or important actions. Future: add accessibility and i18n improvements.
