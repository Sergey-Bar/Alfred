...
// Logic: DeleteConfirmDialog is a modal requiring the user to type "delete" to confirm destructive actions. Handles focus, escape key, and loading state.
// Why: Prevents accidental deletion of critical resources by requiring explicit user confirmation.
// Root Cause: Simple confirm dialogs are too easy to misclick, leading to data loss.
// Context: Used for deleting teams, users, or other sensitive items. Future: consider i18n and accessibility improvements.
// Model Suitability: Modal confirmation logic is standard; GPT-4.1 is sufficient.
