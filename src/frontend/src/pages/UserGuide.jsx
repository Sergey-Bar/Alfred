...
// Logic: Adds interactive admin onboarding modal to User Guide, allowing admins to launch onboarding from help page.
// Why: Static docs are not enough; admins need guided onboarding accessible from help/tutorial flows.
// Root Cause: No way to re-launch onboarding after first login; no contextual onboarding from help.
...
export default function UserGuide() {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <AdminOnboardingModal open={onboardingOpen} onClose={() => setOnboardingOpen(false)} />
