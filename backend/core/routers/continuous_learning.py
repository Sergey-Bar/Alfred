...
def list_wiki_pages():
    ...
    return [
        WikiPage(page_id="kb-001", title="Onboarding Guide", content="Welcome to Alfred!", last_updated="2026-02-15T11:00:00Z"),
        WikiPage(page_id="kb-002", title="API Reference", content="See docs/guides/api.md", last_updated="2026-02-15T11:05:00Z")
    ]
...
def list_learning_events():
    ...
    return [
        LearningEvent(event_id="event-001", name="AI Hackathon", date="2026-03-01", description="Annual AI hackathon event."),
        LearningEvent(event_id="event-002", name="Knowledge Sharing", date="2026-03-15", description="Monthly knowledge sharing session.")
    ]
...
def list_hackathons():
    ...
    return [
        HackathonRecord(hackathon_id="hack-001", name="AI Hackathon", participants=["alice", "bob"], outcome="Winner: alice", date="2026-03-01"),
        HackathonRecord(hackathon_id="hack-002", name="Spring Hackathon", participants=["carol", "dave"], outcome="Runner-up: dave", date="2026-04-01")
    ]
