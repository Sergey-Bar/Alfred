...
// Sprint T064-T183 — new pages
const Onboarding = lazy(() => import('./pages/Onboarding'));
const RequestLog = lazy(() => import('./pages/RequestLog'));
...
const FinOpsExports = lazy(() => import('./pages/FinOpsExports'));
            ...
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/" element={
                  ...
                  <Route path="requests" element={<Suspense fallback={<PageLoader />}><RequestLog /></Suspense>} />
                  <Route path="sso" element={<Suspense fallback={<PageLoader />}><SSOConfig /></Suspense>} />
                  <Route path="forecast" element={<Suspense fallback={<PageLoader />}><BudgetForecast /></Suspense>} />
                  <Route path="prompts" element={<Suspense fallback={<PageLoader />}><PromptRegistry /></Suspense>} />
                  <Route path="finops" element={<Suspense fallback={<PageLoader />}><FinOpsExports /></Suspense>} />
                </Route>
              </Routes>
            </BrowserRouter>
          </WebSocketProvider>
