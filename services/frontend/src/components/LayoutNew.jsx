...
import {
    ...
    ChevronRight, ClipboardCheck, DollarSign, FileText, FlaskConical, GitBranch, Key,
    LayoutDashboard, Link as LinkIcon, LogOut, Menu, MonitorDot, Plug,
...
const navigationGroups = [
    {
        ...
        items: [
            ...
            { name: 'Budget Forecast', href: '/forecast', icon: DollarSign },
        ],
    },
    {
        label: 'CONTROL',
        items: [
            ...
            { name: 'Prompt Registry', href: '/prompts', icon: FileText },
    ...
    },
    {
        ...
        items: [
            ...
            { name: 'SSO Config', href: '/sso', icon: ShieldCheck },
    ...
    },
    {
        ...
        items: [
            ...
            { name: 'Request Log', href: '/requests', icon: MonitorDot },
            { name: 'FinOps Exports', href: '/finops', icon: DollarSign },
        ],
    },
];
...
const getBreadcrumbs = (pathname) => {
    const paths = {
        ...
        '/onboarding': [{ name: 'Dashboard', href: '/' }, { name: 'Onboarding', current: true }],
        '/requests': [{ name: 'Dashboard', href: '/' }, { name: 'Request Log', current: true }],
        '/sso': [{ name: 'Dashboard', href: '/' }, { name: 'SSO Config', current: true }],
        '/forecast': [{ name: 'Dashboard', href: '/' }, { name: 'Budget Forecast', current: true }],
        '/prompts': [{ name: 'Dashboard', href: '/' }, { name: 'Prompt Registry', current: true }],
        '/finops': [{ name: 'Dashboard', href: '/' }, { name: 'FinOps Exports', current: true }],
    };
