...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_token_transfers_sender_id"), "token_transfers", ["sender_id"], unique=False
    )
    op.create_index(
        op.f("ix_token_transfers_recipient_id"), "token_transfers", ["recipient_id"], unique=False
    )
