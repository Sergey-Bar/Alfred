...
export default function Users() {
    ...
    async function fetchUsers() {
        try {
            ...
            // Demo data
            setUsers([
                { user_id: '1', name: 'Alice Johnson', email: 'alice@example.com', personal_quota: 1000, used_tokens: 450, remaining_tokens: 550, usage_percentage: 45, on_vacation: false, is_admin: true },
                { user_id: '2', name: 'Bob Smith', email: 'bob@example.com', personal_quota: 1500, used_tokens: 1200, remaining_tokens: 300, usage_percentage: 80, on_vacation: false, is_admin: false },
                { user_id: '3', name: 'Carol Williams', email: 'carol@example.com', personal_quota: 1000, used_tokens: 200, remaining_tokens: 800, usage_percentage: 20, on_vacation: true, is_admin: false },
                { user_id: '4', name: 'David Brown', email: 'david@example.com', personal_quota: 2000, used_tokens: 1800, remaining_tokens: 200, usage_percentage: 90, on_vacation: false, is_admin: false },
                { user_id: '5', name: 'Eve Davis', email: 'eve@example.com', personal_quota: 1000, used_tokens: 100, remaining_tokens: 900, usage_percentage: 10, on_vacation: false, is_admin: false },
            ]);
        } finally {
            setLoading(false);
        }
