...
export default function Teams() {
    ...
    async function fetchTeams() {
        try {
            ...
            // Demo data
            setTeams([
                { team_id: '1', team_name: 'Engineering', pool_quota: 10000, used_tokens: 6500, remaining_tokens: 3500, usage_percentage: 65, member_count: 8 },
                { team_id: '2', team_name: 'Marketing', pool_quota: 5000, used_tokens: 4200, remaining_tokens: 800, usage_percentage: 84, member_count: 4 },
                { team_id: '3', team_name: 'Research', pool_quota: 15000, used_tokens: 12000, remaining_tokens: 3000, usage_percentage: 80, member_count: 6 },
                { team_id: '4', team_name: 'Support', pool_quota: 3000, used_tokens: 1500, remaining_tokens: 1500, usage_percentage: 50, member_count: 3 },
            ]);
        } finally {
            setLoading(false);
        }
    ...
    async function openMemberModal(team) {
        ...
        try {
            ...
            setTeamMembers([
                { id: '1', name: 'Alice Johnson', email: 'alice@example.com', is_admin: true },
                { id: '2', name: 'Bob Smith', email: 'bob@example.com', is_admin: false },
                { id: '3', name: 'Carol Williams', email: 'carol@example.com', is_admin: false },
            ]);
        } finally {
