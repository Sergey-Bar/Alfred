...
export default function Transfers() {
    ...
    async function fetchUsers() {
        try {
            ...
            setUsers([
                ...
                { user_id: '4', name: 'David Brown', email: 'david@example.com' },
                { user_id: '5', name: 'Eve Davis', email: 'eve@example.com' },
            ]);
        }
    }
    ...
    async function fetchTransfers() {
        try {
            ...
            setTransfers(data.recent_transfers || data);
        } catch (err) {
            setError(err.message);
            // Demo data
            setTransfers([
                { id: '1', from_user_name: 'Alice Johnson', to_user_name: 'Bob Smith', amount: 500, reason: 'Project deadline support', created_at: '2024-01-15T10:30:00Z' },
                { id: '2', from_user_name: 'Carol Williams', to_user_name: 'David Brown', amount: 250, reason: 'Sprint capacity boost', created_at: '2024-01-14T15:45:00Z' },
                { id: '3', from_user_name: 'Eve Davis', to_user_name: 'Alice Johnson', amount: 100, reason: 'Testing automation', created_at: '2024-01-13T09:15:00Z' },
                { id: '4', from_user_name: 'Bob Smith', to_user_name: 'Carol Williams', amount: 750, reason: 'Research project budget', created_at: '2024-01-12T14:20:00Z' },
                { id: '5', from_user_name: 'David Brown', to_user_name: 'Eve Davis', amount: 300, reason: 'Code review support', created_at: '2024-01-11T11:00:00Z' },
            ]);
        } finally {
            setLoading(false);
        }
    ...
    const currentUserName = user?.name || 'Alice Johnson'; // Demo fallback
