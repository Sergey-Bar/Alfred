...
export default function Approvals() {
    ...
    async function fetchApprovals() {
        try {
            ...
            // Demo data
            setApprovals([
                { id: '1', user_name: 'Alice Johnson', user_email: 'alice@example.com', requested_amount: 5000, reason: 'Large project deadline', status: 'pending', created_at: '2026-02-12T10:30:00Z' },
                { id: '2', user_name: 'Bob Smith', user_email: 'bob@example.com', requested_amount: 2000, reason: 'Need extra tokens for testing', status: 'pending', created_at: '2026-02-11T14:15:00Z' },
                { id: '3', user_name: 'Carol Williams', user_email: 'carol@example.com', requested_amount: 3000, reason: 'Research project', status: 'approved', approved_amount: 2500, created_at: '2026-02-10T09:00:00Z' },
                { id: '4', user_name: 'David Brown', user_email: 'david@example.com', requested_amount: 1000, reason: 'Client demo', status: 'rejected', rejection_reason: 'Insufficient justification', created_at: '2026-02-09T16:45:00Z' },
            ]);
        } finally {
            setLoading(false);
        }
                            ...
                            <div className="flex items-start justify-between">
                                ...
                                <div className="text-right">
                                    <p className="text-lg font-bold text-gray-900 dark:text-white mb-2">
                                        {approval.requested_amount?.toLocaleString()} tokens
                                    </p>
                                    {approval.status === 'approved' && approval.approved_amount && (
                                        <p className="text-sm text-green-500">
                                            Approved: {approval.approved_amount.toLocaleString()}
                                        </p>
                                    )}
                                    ...
                                    {approval.status === 'pending' && (
                                        <div className="flex space-x-2 mt-2">
                                            <button
                                                onClick={() => handleApprove(approval.id, approval.requested_amount)}
