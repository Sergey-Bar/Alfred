...
/**
 * DeleteConfirmDialog - A modal that requires typing "delete" to confirm
 * 
 ...
 * @param {string} itemName - Name of the item being deleted (e.g., "Team Alpha")
 * @param {string} itemType - Type of item (e.g., "team", "user")
